...
var app = (function () {
    ...
    function create_then_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input.value = /*currentColor*/ ctx[5];
    			add_location(input, file$2, 27, 4, 953);
    		},
    		m: function mount(target, anchor) {
    ...
    // (25:28)       <p>... Getting online status and settings ...</p>    {:then currentColor}
    function create_pending_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 25, 4, 874);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(25:28)       <p>... Getting online status and settings ...</p>    {:then currentColor}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	handle_promise(/*currentColorFetch*/ ctx[1], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 23, 0, 814);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('controllerIP' in $$props) $$invalidate(0, controllerIP = $$props.controllerIP);
    		if ('currentColorFetch' in $$props) $$invalidate(1, currentColorFetch = $$props.currentColorFetch);
    	};
    	...
    	return [controllerIP, currentColorFetch, onChange];
    }
